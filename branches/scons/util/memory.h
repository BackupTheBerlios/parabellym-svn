...
#ifndef __parabellym_util_memory_h
#define __parabellym_util_memory_h
...
#define IMPLEMENT_ALLOCATORS(classname) \
	funs::pageman classname::_pageman
...
#endif // __parabellym_util_memory_h
